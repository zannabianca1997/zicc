...
# Packaging 
- Packages are prepended with the project name, then hyphen
  separated path from the root. So a package inside `package/path` will be
  called `project-package-path`
