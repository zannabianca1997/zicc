...
>() -> impl Parser<'s, I, K, ParserExtra<'s>> + Clone
where
...
pub(crate) fn punctuator<
    's,
    P,
    I: ValueInput<'s, Token = Result<Token, InvalidToken>, Span = SimpleSpan>,
>() -> impl Parser<'s, I, P, ParserExtra<'s>> + Clone
where
...
pub(crate) fn identifier<
    's,
    I: ValueInput<'s, Token = Result<Token, InvalidToken>, Span = SimpleSpan>,
>() -> impl Parser<'s, I, Identifier, ParserExtra<'s>> + Clone {
    any().try_map(|t, span| {
...
pub(crate) fn int_literal<
    's,
    I: ValueInput<'s, Token = Result<Token, InvalidToken>, Span = SimpleSpan>,
>() -> impl Parser<'s, I, IntLiteral, ParserExtra<'s>> + Clone {
    any().try_map(|t, span| {
